...
void t_sub(struct timeval *out, struct timeval *in);
...

{
    ...
    //double av=(avrtt/MAX_NO_PACKETS);
...

{
...

    {
        ...
        *(unsigned char*)(&answer) = *(unsigned char*)add;
...

{
    ...
    extern int errno;
	//signal(SIGINT, sigintHandler);//Manas 
    signal(SIGINT, stats);
